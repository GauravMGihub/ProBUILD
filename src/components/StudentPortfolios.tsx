        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-8">
          ...
          {portfolioData.map((item, index) => (
            <div key={index} className="relative group">
              ...
              {/* --- FLOATING IMAGE --- */}
              <div className="absolute -top-10 left-8 z-20">
                <div className="w-20 h-20 rounded-full border-4 border-slate-50 shadow-lg overflow-hidden bg-white transition-transform duration-500 ease-out group-hover:scale-125">
                  <img 
                    src={item.image} 
                    alt={item.student} 
                    className="w-full h-full object-cover" 
              ...
              {/* --- BLUE CARD --- */}
              <div className="bg-blue-600 rounded-3xl p-8 pt-12 h-full relative overflow-hidden shadow-xl transition-transform duration-300 group-hover:-translate-y-2 flex flex-col">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mt-auto grid grid-cols-5 gap-3">
                    ...
                    <a 
                      href={item.link} 
                      className="col-span-3 inline-flex items-center justify-center px-4 py-3 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-colors shadow-md group-hover:shadow-lg text-sm"
                    >
                    ...
                    <a 
                      href={item.linkedin}
                      className="col-span-2 inline-flex items-center justify-center px-4 py-3 bg-blue-700/50 border border-blue-400/30 text-white font-bold rounded-xl hover:bg-blue-700 hover:border-white/50 transition-colors shadow-md text-sm backdrop-blur-sm"
                    >
